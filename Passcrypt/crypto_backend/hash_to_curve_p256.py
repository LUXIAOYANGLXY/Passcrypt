...
# ── 域分离字符串 (DST) ───────────────────────────────────────────────
# OPRF / PAEE H2 专用 DST；RFC 9380 附录测试向量用 DST
PAEE_H2_DST = b"PAEE-H2-v6-P256_XMD:SHA-256_SSWU_RO_"
...
# ── RFC 9380 expand_message / hash_to_field / SSWU ───────────────────
