...
class TestFactorize(unittest.TestCase):
    ...
    KNOWN = [
        (17833_16739, (1298693, 1371463)),
        (1724114033281923457, (1308665633, 1317552129)),
        (7, (1, 7)),
    ]
...
def _bench(fn, *args, n=50, label=""):
    ...
    print(f"  {label:40s} {throughput_mb:8.1f} MB/s  ({n} runs x {size//1024} KB)")
